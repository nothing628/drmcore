...
export function set_target_webp(a: number, b: number, c: number): number;
export function set_target_jpeg(a: number, b: number, c: number): number;
export function set_watermark_webp(a: number, b: number, c: number): number;
export function set_watermark_jpeg(a: number, b: number, c: number): number;
export function set_key(a: number, b: number, c: number): number;
export function destroy_watermarktask(a: number): void;
export function process_watermark(a: number): number;
export function get_old_section_webp(a: number, b: number): number;
export function get_old_section_jpeg(a: number, b: number): number;
export function get_output_webp(a: number, b: number): number;
export function get_output_jpeg(a: number, b: number): number;
